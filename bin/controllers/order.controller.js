...
var OrderController = /** @class */ (function () {
    ...
    OrderController.prototype.getOrderByID = function (operator, id) {
        return __awaiter(this, void 0, void 0, function () {
            var service;
            return __generator(this, function (_a) {
                service = new order_service_1.default(operator);
                return [2 /*return*/, service.getOrderById(id)];
            });
        });
    };
    OrderController.prototype.getOrders = function (operator, params) {
        return __awaiter(this, void 0, void 0, function () {
            var service;
            return __generator(this, function (_a) {
                service = new order_service_1.default(operator);
                return [2 /*return*/, service.getOrders(params)];
            });
        });
    };
    ...
    OrderController.prototype.removeOrder = function (operator, order) {
        return __awaiter(this, void 0, void 0, function () {
            var service;
            return __generator(this, function (_a) {
                service = new order_service_1.default(operator);
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [operator_1.default, order_1.default]),
        __metadata("design:returntype", Promise)
    ], OrderController.prototype, "getOrders", null);
    __decorate([
        routing_controllers_1.Authorized('addOrders'),
    ...
    __decorate([
        routing_controllers_1.Authorized('updateOrders'),
    ...
    __decorate([
        routing_controllers_1.Authorized('removeOrders'),
    ...
    OrderController = __decorate([
        routing_controllers_1.Controller("/orders")
    ], OrderController);
