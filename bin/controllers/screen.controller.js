...
var ScreenController = /** @class */ (function () {
    ...
    ScreenController.openKitchen = function (socket) {
        ScreenController.socket = socket;
    };
    ScreenController.addClient = function (client, partnerID, storeID, operator, isScreen) {
        return __awaiter(this, void 0, void 0, function () {
            var letterIN, letterFI, reqTime, code, map, orderMap, storemap;
            return __generator(this, function (_a) {
                if (isScreen) {
                    ...
                    if (ScreenController.screens.has(partnerID)) {
                        if (ScreenController.screens.get(partnerID).has(storeID))
                            ScreenController.screens.get(partnerID).get(storeID).set(code, client);
                        else {
                            map = new Map();
                            map.set(code, client);
    ...
    ScreenController.receiveSocket = function (message, route) {
        try {
    ...
    ScreenController.screens = new Map();
    ScreenController.controllers = new Map();
