        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.response.notification = new notification_1.default("Operador adicionado com sucesso!");
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        console.error(error_1);
                        this.response.success = false;
                        this.response.notification = new notification_1.default("Um erro ocorreu ao adicionar esse operador. Por favor, tente novamente mais tarde ou verifique se todas as informações estão corretas.");
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.response.notification = new notification_1.default("Operador excluído com sucesso!");
                        return [3 /*break*/, 3];
                    case 2:
                        error_2 = _a.sent();
                        console.error(error_2);
                        this.response.success = false;
                        this.response.notification = new notification_1.default("Um erro ocorreu ao excluir esse operador. Por favor, tente novamente mais tarde ou verifique se todas as informações estão corretas.");
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/, this.response];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.response.notification = new notification_1.default("Operador atualizado com sucesso!");
                        return [3 /*break*/, 3];
                    case 2:
                        error_3 = _a.sent();
                        console.error(error_3);
                        this.response.success = false;
                        this.response.notification = new notification_1.default("Um erro ocorreu ao atualizar esse operador. Por favor, tente novamente mais tarde ou verifique se todas as informações estão corretas.");
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/, this.response];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.response.success = false;
                        this.response.notification = new notification_1.default("Ocorreu um erro ao procurar por este operador. Por favor, tente mais tarde ou fale com um administrador.");
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/, this.response];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.response.success = false;
                        this.response.notification = new notification_1.default("Ocorreu um erro ao procurar por operadores. Por favor, tente mais tarde ou fale com um administrador.");
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/, this.response];
                }
            });
