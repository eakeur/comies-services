...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getCount = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, error_6;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = this.response;
                        _b = {};
                        return [4 /*yield*/, this.collection.count(filters)];
                    case 1:
                        _a.data = (_b.quantity = _c.sent(), _b.filters = filters, _b);
                        return [3 /*break*/, 3];
                    case 2:
                        error_6 = _c.sent();
    ...
    ProductService.prototype.select = function (select) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _a, error_7;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        ...
                        _a = this.response;
                        return [4 /*yield*/, query.where(select).getMany()];
                    case 1:
                        _a.data = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
