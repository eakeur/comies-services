...
import 'package:comies/views/startup/widgets/serverfinder-widget.dart';
import 'package:comies/views/startup/widgets/welcome-widget.dart';

import 'startup.controller.dart';
      ...
      body: Builder(builder: (context) {
        return Padding(
          ...
          child: Wrap(
            children:[
              Hero(
                tag: ValueKey('WelcomeMessage'),
                child: WelcomeWidget(),
              ),
              ValueListenableBuilder<ConnectionType>(
                valueListenable: controller.connectionTypeNotifier,
                builder: (context, connectionType, child) => ServerFinderWidget(connectionType: connectionType, onTypeChange: controller.onConnectionTypeChange),
              ),
              ValueListenableBuilder<String>(
                valueListenable: controller.ipNotifier,
