...
class _FormGroupState extends State<FormGroup> {
  ...
  bool get isBigScreen => MediaQuery.of(context).size.width > 700 - 150;
          ...
          for (var row in widget.build!.keys) isBigScreen 
           ? Row(children: [
            for (var field in widget.build![row]!['fields']!) 
              Expanded(flex: widget.build![row]!['spaces']![widget.build![row]!['fields']!.indexOf(field)] ?? 100,
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: Row(
          ...
          children: [
            ...
            IconButton(icon: Icon(Icons.search), onPressed: widget.onSearchTap as void Function()?),
