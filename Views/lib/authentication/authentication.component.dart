...
class AuthenticationComponent extends StatefulWidget {
  ...
  AuthenticationComponent({Key? key, required this.canGo}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Row(
                  children: [
                    Checkbox(value: stayConnected, onChanged: (value) => setState(() {}), activeColor: Theme.of(context).accentColor),
                    SizedBox(width: 20),
              ...
              SizedBox(height: 30),
              TextButton(onPressed: operatorController.text.trim() != "" && passwordController.text.trim() != "" ? login : null, child: Text('ENTRAR'))
            ],
          ),
        ),
      ),
